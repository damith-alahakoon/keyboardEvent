...
public class HomeActivity extends AppCompatActivity {
    ...
    private static String TAG = "SinhalaActivity";
...
/////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(HomeActivity.this, "Logged out after 1 minutes on inactivity.", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    protected void setLanguage(String language) {
        ...
        Intent refreshIntent = new Intent(this, HomeActivity.class);
        finish();
        startActivity(refreshIntent);
    }

    public void goHome(View view) {
        startActivity(new Intent(this, TestTimeOutActivity.class));
    }
}
